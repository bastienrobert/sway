...
export default class Drown {
  ...
  initIntroTL() {
    ...
    this.introTL.fromTo(
      [this.refs.drown.blueSea.secondPointBlue, this.refs.drown.blueSea.secondDarkBlue, this.refs.drown.blueSea.secondDarkerBlue, this.refs.drown.blueSea.secondBlue],
      1, {
        autoAlpha: 1
      }, {
        repeat:4,
  ...
  drowningParallax = () => {
    TweenMax.to(
      [this.refs.drown.drowning.boisAP, this.refs.drown.drowning.boisGauchePPOne, this.refs.drown.drowning.boisRouge],
      0.5, {
    ...
    TweenMax.to(
      [this.refs.drown.drowning.boisGauchePPTwo, this.refs.drown.drowning.boisGaucheAP],
      0.5, {
        xPercent: '-' + (values.mouse.x / values.viewport.width) * 8,
